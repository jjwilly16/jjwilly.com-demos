...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/datatables.net/js/jquery.dataTables.js":[function(require,module,exports) {
var define;
/*! DataTables 1.10.19
...
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js":[function(require,module,exports) {
var define;
...
},{"datatables.net":"../node_modules/datatables.net/js/jquery.dataTables.js"}],"../node_modules/datatables.net-buttons/js/dataTables.buttons.js":[function(require,module,exports) {
var define;
var process = require("process");
...
},{"datatables.net":"../node_modules/datatables.net/js/jquery.dataTables.js","process":"../node_modules/process/browser.js"}],"../node_modules/datatables.net-buttons-bs4/js/buttons.bootstrap4.js":[function(require,module,exports) {
var define;
...
},{"datatables.net-bs4":"../node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js","datatables.net-buttons":"../node_modules/datatables.net-buttons/js/dataTables.buttons.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var $table = (0, _jquery.default)('#mytable');
$table.DataTable({
  ...
  buttons: [{
    ...
    action: function action(e, dt) {
      ...
      var fileName = 'people';
      var sheetName = 'People'; // Organize table data

      var order = dt.order();
      var orderDir = order[0][1];
      var orderBy = dt.init().columnDefs[order[0][0]].data;
      var search = dt.search() || null;
      var columns = JSON.stringify(dt.init().columnDefs); // This is used to send to the backend, where a
      ...
      var token = Date.now(); // Dynamically create and submit a form

      function nonAjaxPost(path, params) {
      ...
      (0, _jquery.default)('#spinner').show(); // Initialize download
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","datatables.net-bs4":"../node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js","datatables.net-buttons-bs4":"../node_modules/datatables.net-buttons-bs4/js/buttons.bootstrap4.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
